...
export function variableCanAcceptFormula(variableDesc: VariableDefine.Desc, formulaType: WithDynamicVariable): boolean {
  ...
  if (variableDesc.type === 'object') {
    ...
    for (const key in variableDesc.prototype) {
      ...
      if (!variableCanAcceptFormula(variableDesc.prototype[key], formulaType.prototype[key])) return false
    }
  ...
  if (variableDesc.type === 'array') {
    ...
    return variableCanAcceptFormula(variableDesc.item as VariableDefine.Desc, formulaType.item)
  }
